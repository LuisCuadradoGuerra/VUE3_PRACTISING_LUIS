# Welcome to Comando City

Aquí encontrarás las listas de comandos para las extensiones EsLint y Prettier para tu comodidad y disfrute.
...
--report-unused-disable-directives-severity String Chooses severity level for reporting unused eslint-disable and eslint-enable directives

- either: off, warn, error, 0, 1, or 2
